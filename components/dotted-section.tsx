...
export default function DottedSection({
  ...
  return (
    <div id={id} className={`relative w-full ${className}`}>
      <div className="pointer-events-none absolute top-0 left-0 right-0 z-10 h-[1px] rule-x" />
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 z-10 h-[1px] rule-x" />
